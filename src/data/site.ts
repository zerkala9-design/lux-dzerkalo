...
export const siteI18n = {
  uk: {
    ...
    description:
      'Виготовлення та монтаж дзеркал на замовлення у Києві: дзеркала для ванної, з фацетом, з LED-підсвіткою, дзеркальна плитка, панно та дзеркала для спортзалів. Заміри, доставка, професійний монтаж.',
  },
  ru: {
    addressFull: 'г. Киев, ул. Вадима Гетьмана, 27',
    workingHours: 'Пн–Сб: 10:00 – 18:00',
    description:
      'Изготовление и монтаж зеркал на заказ в Киеве: зеркала для ванной, с фацетом, с LED-подсветкой, зеркальная плитка, панно и зеркала для спортзалов. Замеры, доставка, профессиональный монтаж.',
  },
} as const;

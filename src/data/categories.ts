...
export const categories: Category[] = [
  ...
  },
  {
    ...
    short: 'Скляні фартухи, полиці, стільниці',
    description:
      'Вироби зі скла на замовлення: кухонні фартухи (скіналі), полиці, стільниці, скляні перегородки. Загартоване скло 4–10 мм з обробкою кромки.',
  },
];
